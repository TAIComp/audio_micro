...
# func NewAudioTranscriber(cancel context.CancelFunc) *AudioTranscriber {
...
# 			// Check for interrupt commands if this is a final result
# 			if result.IsFinal && at.containsInterruptCommand(transcript) {
...
# 	// Reset the current sentence and other states
# 	at.CurrentSentence = ""
# 	at.LastTranscript = ""
...
# 	// Reset generation flag and show listening message
# 	at.mu.Lock()
# 	at.stopGeneration = false
# 	at.mu.Unlock()
...
# 	log.Println("\nVoice interrupt command detected!")
# 	at.handleInterrupt()
# }
...
# 	// Create transcriber with the cancellation function
# 	transcriber := NewAudioTranscriber(cancel)
...
# 	go transcriber.handleInterrupts(ctx)
...
#     normalizedText := strings.ToLower(strings.TrimSpace(transcript))
...
#                         } else {
#                             fmt.Println("Processing: Incomplete sentence detected with 3 seconds silence")
#                         }
...
# // Add new method for processing sentences
