...
class AudioTranscriber:
    ...
    def check_silence(self):
        ...
        while True:
            ...
            if self.last_final_transcript and not self.is_processing:
                if (self.last_sentence_complete and silence_duration >= 1) or \
                   (not self.last_sentence_complete and silence_duration >= 2):
                    self.is_processing = True
                    print("\nProcessing complete sentence...")
                    # Get context index for the sentence
    ...
    def handle_responses(self, responses):
        ...
        for response in responses:
            ...
            # Check if we're currently playing any audio
