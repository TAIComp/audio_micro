...
class AudioTranscriber:
    ...
    def get_context_and_completion(self, text):
        ...
        return self.aiHandler.get_context_and_completion(text)
        ...
        try:
            ...
            def generate_and_convert():
                ...
                if response and not self.stop_generation:
                    ...
                    # Convert to audio and play immediately if not interrupted
            ...
            # 3. Play random audios until response thread completes
            while response_thread.is_alive() and not self.stop_generation:
